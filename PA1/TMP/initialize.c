...
struct	qent	rtq[NQENT];	/* real time q table			*/
...
int	epoch = 0;		/* System epoch time			*/
int bestproc = 0;		/* Process with the best goodness	*/
int	scheduler = 0;		/* Scheduler (default/linux/multi)	*/
int	goodness[NPROC];
